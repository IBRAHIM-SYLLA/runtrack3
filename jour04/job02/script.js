...
window.addEventListener("DOMContentLoaded", (event) =>{
    ...
    let objet =
    '{"name": "La Plateforme_", "address": "8 rue dhozier", "city": "Marseille", "nb_staff": "11", "creation":"2019"}';
    function jsonValueKey(objet, cle){
        let json = JSON.parse(objet);
        console.log(json[cle]);
    }
